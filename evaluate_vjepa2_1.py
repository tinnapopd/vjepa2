...
def get_vjepa_video_classification_results(classifier, out_patch_features_pt):
    ...
    top5_probs = (
        F.softmax(out_classifier.topk(5).values[0]) * 100.0
...
def run_sample_inference():
    ...
    hf_model_name = "facebook/vjepa2-vitg-fpc64-384"  # Replace with your favored model, e.g. facebook/vjepa2-vitg-fpc64-384
