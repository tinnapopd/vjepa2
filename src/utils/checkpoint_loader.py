...
def robust_checkpoint_loader(
    r_path: str, map_location: MAP_LOCATION = "cpu", max_retries: int = 3
) -> Any:
    """
    ...
    while retries < max_retries:
        try:
            ...
            if retries < max_retries:
                ...
                logger.warning(
                    f"Sleeping {sleep_time_s}s and trying again, count {retries}/{max_retries}"
                )
